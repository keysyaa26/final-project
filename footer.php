...
<div class="container-fluid py-5" style="background-color: #2C2C7C;">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mx-5 footer-container">
        <!-- About Section -->
        <div class="about-section mb-4 mb-md-0" style="flex: 1; margin-right: 50px;">
            ...
            <p style="line-height: 1.8; color: #FFFFFF;">
                ...
                mengenai event-event menarik yang dapat diikuti. Kami berdedikasi untuk memberikan pengalaman terbaik
        ...
        <div class="social-media-section text-center" id="social-media" style="flex: 1;">
            ...
            <div class="d-flex justify-content-center mt-3">
                <a href="#" class="text-decoration-none mx-3" aria-label="Facebook"
                    style="color: #FFF000; font-size: 1.5rem;">
                    <i class="bi bi-facebook"></i>
                </a>
                <a href="#" class="text-decoration-none mx-3" aria-label="Twitter"
                    style="color: #FFF000; font-size: 1.5rem;">
                    <i class="bi bi-twitter"></i>
                </a>
                <a href="#" class="text-decoration-none mx-3" aria-label="Instagram"
                    style="color: #FFF000; font-size: 1.5rem;">
