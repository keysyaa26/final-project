...
<div class="container-fluid">
    ...
    <?php foreach($events as $event):?>
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="../../assets/uploads/poster/<?= $event['poster'] ? $event['poster'] : 'default-image.jpg' ?>" class="custom-card-img card-img-top" alt="<?= htmlspecialchars($event['title']) ?>">
                <div class="card-body"> 
                    <h5 class="card-title">
                ...
                <p class="card-text">
                    ...
                    <a href="event_detail.php?id=<?= $event['event_ID'] ?>" class="btn btn-primary">Lihat detail</a>
