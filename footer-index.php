...
<div class="container-fluid py-5" style="background-color: #2C2C7C;">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start mx-5 footer-container">
        <!-- About Section -->
        <div class="about-section" style="flex: 1; margin-right: 30px;">
